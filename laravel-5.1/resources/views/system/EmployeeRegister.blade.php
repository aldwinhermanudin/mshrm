...
@if ($language == 'id')
<title>2016 mshrm ⋅ Tambahkan Pegawai</title>

  <div class="content-wrapper">
    <section class="content-header">
      <h1>Tambahkan Pegawai <small>Tambahkan Pegawai Baru.</small></h1>
      <ol class="breadcrumb">
        <li><i class="fa fa-dashboard"></i> Tambahkan Pegawai</li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-success">
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Tambahkan Pegawai Baru ⋅ <span class="label label-success">Dengan file .CSV</span></h3>
            ...
            <form id="form_2" method="post" enctype="multipart/form-data" autocomplete="off" action="/system/EmployeeRegisterFile">
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="form-group">
                      ...
                      <p class="help-block">Hanya dalam .CSV format.</p>
                    </div>
                  </div>
                </div>
              ...
              <div class="box-footer">
                <button type="submit" id="form_2_button_submit" class="btn btn-info btn-flat">Submit</button>
          ...
          <div class="box box-info">
            ...
            <!--BOX HEADER START-->
            <div class="box-header with-border">
              <h3 class="box-title">Tambahkan Pegawai Baru ⋅ <span class="label label-info">Masukkan data secara manual</span></h3>
              <div class="box-tools pull-right">
                <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
              </div>
            </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <p class="help-block">Gambar profil dalam format .JPG.</p>
                    </div>
                  </div>

                  <div class="col-md-6">

                    <h4><b>Informasi Keluarga</b></h4>
                    <hr>
...
$(document).ready(function(){
  ...
  $("#form_1").submit(function(){
      ...
      $.ajax({
          ...
          error: function (data) {
            $("#form_feedback").empty().html("<div class='callout callout-warning'><h5>Terjadi kesalahan, coba kembali dalam waktu dekat.</h5></div>");
    				$("#form_1_button_submit").prop('disabled',false);
          },
          cache: false,
          contentType: false,
