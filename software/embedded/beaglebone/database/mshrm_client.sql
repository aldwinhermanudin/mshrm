...
--
-- Table structure for table `employee_uid`
--

CREATE TABLE IF NOT EXISTS `employee_uid` (
  `uid` varchar(8) NOT NULL,
  `name` varchar(35) NOT NULL DEFAULT 'unverified',
  `short_name` varchar(24) NOT NULL DEFAULT 'unverified',
  `flash_id` int(5) DEFAULT NULL,
...
--
-- Dumping data for table `employee_uid`
--

INSERT INTO `employee_uid` (`uid`, `name`, `short_name`, `flash_id`, `verified`) VALUES
('cf994312', 'Yudi Andrean', 'Yudi', 3, 1);
