...
#define FINGERPRINT_UPIMG 0x0A
#define FINGERPRINT_DWNIMG 0x0B
...
class Adafruit_Fingerprint {
 public:
  ...
  uint32_t upImage(void);
  uint8_t downBuffer(void);
  ...
  uint8_t createFollowUp(uint8_t buffer[128]);
uint8_t endFollowUp(uint8_t buffer[128]);
